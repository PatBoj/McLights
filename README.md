...
- **18.01.2026** change the name of the package, install current projet as a package, add function to download and save Open Street Maps and prepeare scripts to download data
